...
bulk.ens2 <- SCDC_ENSEMBLE(bulk.eset = bulk.eset, sc.eset.list = list(X02 = sc02.qc$sc.eset.qc, X03 = sc03.qc$sc.eset.qc, X04 = sc04.qc$sc.eset.qc), ct.varname = "cellType",
